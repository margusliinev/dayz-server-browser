...
export function RefreshButton({ onRefresh }: RefreshButtonProps) {
    ...
    return (
        <button
            ...
            className={`w-8 h-8 flex items-center justify-center rounded-full border border-gray-700 bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all relative ${refreshing ? 'opacity-60 cursor-not-allowed' : ''} ml-4`}
        >
